...
function getAuth($username, $password){
        ...
        //$url = 'https://addons.amulex.ru/ldap/auth.php';
        $url = 'https://ldap-dev.amulex.ru/v1/user-ldap/login?username='.$username.'&password='.$password;
        $curl  = curl_init($url);
...
$result = getAuth($_POST['login'], $_POST['password']);
